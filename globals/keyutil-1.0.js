 ...
 */
KEYUTIL.export function getPEM(keyObjOrHex, formatType, passwd, encAlg, hexType, ivsaltHex) {
 ...
 * </ul>
 */
KEYUTIL.export function parseCSRHex(csrHex) {
	let result = {};
	let h = csrHex;
	...
	result.p8pubkeyhex = getTLV(h, a2[2]);
